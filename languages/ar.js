...
window.translations['ar'] = {
        ...
        // Reviews section
        'user_reviews': 'شهادات المستخدمين',
        ...
        'about_us': 'من نحن',
        'our_mission': 'مهمتنا',
        'mission_content': 'نؤمن أن معالجة الصور يجب ألا تعتمد على برامج معقدة أو سير عمل مرهق. مهمتنا في JPG Convert بسيطة: جعل تحويل وضغط JPG سهلاً وفعالاً وآمناً للجميع. سواء كنت تعمل على سطح المكتب أو الجهاز اللوحي أو الأجهزة المحمولة أو تدمج أدواتنا في سير عملك، نحن نقدم حلولاً سريعة وموثوقة وسهلة الاستخدام.',
        'our_story': 'قصتنا',
        'story_content': 'تم إطلاق JPG Convert من قبل LensClear.net — منصة مستقلة تركز على التعليم الفوتوغرافي ومراجعات المعدات. بعد سنوات من إنشاء المحتوى والتفاعل مع المستخدمين، فهمنا نقاط الألم الشائعة التي يواجهها المصورون عند التعامل مع صور JPG: توافق التنسيقات، الملفات الكبيرة جداً، فقدان الجودة، وأكثر.',
        'story_content2': 'لتلبية احتياجاتنا العملية لتحسين الصور واحتياجات جمهورنا، أنشأنا JPG Convert — أداة مبنية بعقلية "الصورة أولاً". كان الهدف واضحاً منذ البداية: التركيز على تحويل وضغط وتحسين تنسيق JPG — بدون ميزات إضافية، بدون تشتيت.',
        'story_content3': 'من التحويل الأساسي من JPG إلى WebP و AVIF، إلى الميزات المتقدمة مثل الضغط بدون فقدان، المعالجة الدفعية، إزالة بيانات Exif، ومعالجة الخلفيات الشفافة، نحافظ دائماً على مبدأ واحد: بناء أدوات يحتاجها المصورون فعلاً، من منظور المصور.',
        'about_lensclear': 'حول LensClear.net',
        'lensclear_content': 'LensClear.net هي منصة محتوى مستقلة لعشاق التصوير حول العالم. تركز على الموارد التعليمية، أدلة استخدام المعدات، ووجهات نظر أصلية حول التصوير. JPG Convert هو امتداد لفلسفتنا "التصوير + التكنولوجيا" — يمثل خطوتنا الأولى في عالم أدوات معالجة الصور.',
        'visit_lensclear': 'زيارة LensClear.net ←',
        'our_values': 'قيمنا',
        'privacy_title': 'الخصوصية أولاً',
        'privacy_content': 'تتم جميع معالجة الصور محلياً في متصفحك. صورك لا تغادر جهازك أبداً، مما يضمن الخصوصية والأمان الكاملين.',
        'speed_title': 'سرعة البرق',
        'speed_content': 'الخوارزميات المحسنة والمعالجة المحلية تضمن تحويلات سريعة بدون الحاجة لرفع أو تنزيل من الخادم.',
        'quality_title': 'التركيز على الجودة',
        'quality_content': 'تقنيات الضغط المتقدمة تحافظ على الجودة البصرية مع تقليل حجم الملف بشكل كبير للحصول على أداء ويب مثالي.',
        'accessibility_title': 'الوصول الشامل',
        'accessibility_content': 'يعمل بسلاسة على جميع الأجهزة والمنصات — سطح المكتب والجهاز اللوحي والمحمول — بدون تثبيت برامج.',
        'get_in_touch': 'تواصل معنا',
        'contact_content': 'لديك أسئلة أو اقتراحات أو ملاحظات؟ نحب أن نسمع منك. تواصل معنا لمساعدتنا في جعل JPG Convert أفضل.',
        'footer_navigation': 'التنقل',
        'footer_operated_by': 'JPG Convert مُشغل بواسطة LensClear.net',
        'footer_visit_lensclear': 'زيارة LensClear.net',
        'footer_privacy_note': 'نحترم خصوصيتك. جميع التحويلات تتم معالجتها محلياً في متصفحك.',
        'footer_copyright': '© 2025 JPG Convert. جميع الحقوق محفوظة.'
    };