...
window.translations['ru'] = {
        ...
        // Reviews section
        'user_reviews': 'Свидетельства пользователей',
        ...
        'mission_content': 'В LensClear.net наша миссия - предоставить пользователям мощные, безопасные и простые в использовании инструменты для конвертации изображений. Мы считаем, что высококачественная обработка изображений должна быть доступна всем, не ставя под угрозу конфиденциальность или безопасность.',
        'our_story': 'Наша история',
        'story_content': 'LensClear.net была основана в ответ на растущие потребности веб-разработчиков и дизайнеров, которым нужны быстрые и надежные решения для конвертации изображений. Мы видели, что существующие инструменты были медленными, имели проблемы с конфиденциальностью или не хватало необходимых функций. Поэтому мы решили создать лучшее решение.',
        'about_lensclear': 'О LensClear.net',
        'lensclear_content': 'LensClear.net является пионером в современной технологии конвертации изображений. Наша платформа полностью основана на браузере, что означает, что ваши изображения никогда не покидают ваше устройство. Мы поддерживаем новейшие форматы изображений, включая WebP, AVIF, PNG и TIFF, предоставляя вам гибкость выбора правильного формата для ваших конкретных потребностей.',
        'our_values': 'Наши ценности',
        'privacy_title': 'Конфиденциальность',
        'privacy_content': 'Ваши изображения принадлежат вам. Вся наша обработка выполняется локально в вашем браузере.',
        'speed_title': 'Скорость',
        'speed_content': 'Мы оптимизированы для быстрого времени конвертации и эффективной пакетной обработки.',
        'quality_title': 'Качество',
        'quality_content': 'Наши алгоритмы обеспечивают наилучший баланс между размером файла и качеством изображения.',
        'accessibility_title': 'Доступность',
        'accessibility_content': 'Наши инструменты разработаны для всех, независимо от технической экспертизы.',
        'get_in_touch': 'Свяжитесь с нами',
        'contact_content': 'Есть вопросы или предложения? Мы будем рады услышать от вас! Свяжитесь с нами и расскажите, как мы можем сделать LensClear.net еще лучше.',
        ...
        'footer_jpg_webp': 'JPG в WebP',
        'footer_jpg_avif': 'JPG в AVIF',
        'footer_jpg_png': 'JPG в PNG',
        'footer_jpg_tiff': 'JPG в TIFF',
        'footer_copyright': '© 2024 LensClear.net. Все права защищены.',
